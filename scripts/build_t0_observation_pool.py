...
def main() -> None:
    ...
    ap.add_argument("--inbox", default=str(DEFAULT_INBOX), help="Used when --chatgpt-file is omitted")
    ...
    payload, source = read_payload(args.chatgpt_file, Path(args.inbox))
    ...
    dated, latest = publish(document, Path(args.output_dir))
